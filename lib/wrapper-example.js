...
(function() {
  ...
  wrapper.onStream('open', function() {
    ...
    return wrapper.subscribeAccountIndicators();
  });

  wrapper.onStream('close', function() {
    return print("Stream closed");
  });

  wrapper.onStream('error', function(err) {
  ...
  wrapper.useStream(function(msg, client) {
    return print("I AM SUCH A GOOD PLUGIN WOOO!");
  });
