...
(function() {
  ...
  Wrapper = (function() {
    ...
    Wrapper.prototype.subscribeCandles = function() {
      this._sendStream(this._connector.buildStreamCommand('getCandles', this._stream_session_id));
    };
    ...
    Wrapper.prototype.subscribeTickPrices = function(symbols) {
      this._sendStream(this._connector.buildStreamCommand('getTickPrices', this._stream_session_id, symbols));
    };
