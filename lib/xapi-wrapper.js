...
(function() {
  ...
  Wrapper = (function() {
    function Wrapper(server_url, conn_port, stream_port, username, password) {
      ...
      this._connector.on('message', (function(_this) {
        return function(msg) {
          ...
          try {
            ...
            if (res.status === true) {
              _this._emitter.emit('_message', req, res);
              return _this._emitter.emit(req.command, req, res);
            } else {
      ...
      this._connector.onStream('message', (function(_this) {
        return function(msg) {
          ...
          try {
            msg = JSON.parse(msg);
            _this._streamEmitter.emit('_message', msg);
            return _this._streamEmitter.emit(msg.command, msg);
          } catch (_error) {
            e = _error;
            return console.log(e);
          }
    ...
    Wrapper.prototype.use = function(event, callback) {
      if (arguments.length === 2) {
        return this.on(event, callback);
      } else {
        return this.on('_message', callback);
      }
    };

    Wrapper.prototype.useStream = function(callback) {
      if (arguments.length === 2) {
        return this.onStream(event, callback);
      } else {
        return this.onStream('_message', callback);
      }
    };
    ...
    Wrapper.prototype._sendStream = function(msg) {
      return this._connector.sendStream(msg);
    };
    ...
    Wrapper.prototype.connectStream = function() {
      return this._connector.connectStream();
    };

    Wrapper.prototype.disconnectStream = function() {
      return this._connector.disconnectStream();
    };
    ...
    Wrapper.prototype.getAccountIndicators = function(custom_tag) {
      return this._send('getAccountIndicators', null, custom_tag);
    };

    Wrapper.prototype.getAccountInfo = function(custom_tag) {
      return this._send('getAccountInfo', null, custom_tag);
    };

    Wrapper.prototype.getAllSymbols = function(custom_tag) {
      return this._send('getAllSymbols', null, custom_tag);
    };

    Wrapper.prototype.getCalendar = function(custom_tag) {
      return this._send('getCalendar', null, custom_tag);
    };
    ...
    Wrapper.prototype.getStepRules = function(custom_tag) {
      return this._send('getStepRules', null, custom_tag);
    };
    ...
    Wrapper.prototype.getTrades = function(custom_tag) {
      return this._send('getTrades', null, custom_tag);
    };
    ...
    Wrapper.prototype.getVersion = function(custom_tag) {
      return this._send('getVersion', null, custom_tag);
    };
    ...
    Wrapper.prototype.subscribeAccountIndicators = function() {
      return this._sendStream(this._connector.buildStreamCommand('getAccountIndicators', this._stream_session_id));
    };

    Wrapper.prototype.subscribeCandles = function() {
      return this._sendStream(this._connector.buildStreamCommand('getCandles', this._stream_session_id));
    };

    Wrapper.prototype.subscribeKeepAlive = function() {
      return this._sendStream(this._connector.buildStreamCommand('getKeepAlive', this._stream_session_id));
    };

    Wrapper.prototype.subscribeNews = function() {
      return this._sendStream(this._connector.buildStreamCommand('getNews', this._stream_session_id));
    };

    Wrapper.prototype.subscribeOrderStatus = function() {
      return this._sendStream(this._connector.buildStreamCommand('getOrderStatus', this._stream_session_id));
    };

    Wrapper.prototype.subscribeProfits = function() {
      return this._sendStream(this._connector.buildStreamCommand('getProfits', this._stream_session_id));
    };

    Wrapper.prototype.subscribeTickPrices = function(symbols) {
      return this._sendStream(this._connector.buildStreamCommand('getTickPrices', this._stream_session_id, symbols));
    };

    Wrapper.prototype.subscribeTrades = function() {
      return this._sendStream(this._connector.buildStreamCommand('getTrades', this._stream_session_id));
    };
